...
def simulation_setting(time_steps, num_server, num_user):    
    """
    Make Simulation Parameters
    """
    sim_param = Sim_Params(time_steps, x_length = 2.4, y_length = 1.7, max_edge_length=1,num_path_limit=1)
    ...
    job_profile1 = Job_Profile(job_name = "VR",
                               ...
                               length_range=[time_steps,time_steps],  
    ...
    num_user_m0_ONE = num_user # stochastic - ONE
